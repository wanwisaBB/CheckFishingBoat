...
public class boat_out_view extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boat_out_view);
        ...
        String url = MyConnection.url + "boat_out_view_search.php";
        ...
        try {
            ...
            SimpleAdapter sAdap;
            sAdap = new SimpleAdapter(boat_out_view.this, MyArrList, R.layout.list_boat_out_view_adap,
                    new String[]{data1}, new int[]{R.id.textView106});
            ...
            searchListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Intent intent = new Intent(getApplication(), boat_out_view_select.class);
    ...
    private void widget() {
        searchEditText = (EditText) findViewById(R.id.editText85);
        searchListView = (ListView) findViewById(R.id.listView3);
        searchButton = (Button) findViewById(R.id.button8);
